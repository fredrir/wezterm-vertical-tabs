...
return {
  ...
  options = {
    ...
    { description = "Default accent color", group = "theme", key = "accent", kind = "color", label = "Accent" },
    { description = "Surface background", group = "theme", key = "background", kind = "color", label = "Background" },
    { description = "Text foreground", group = "theme", key = "foreground", kind = "color", label = "Foreground" },
    { description = "Secondary text foreground", group = "theme", key = "muted", kind = "color", label = "Muted" },
    {
