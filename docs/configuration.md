...
| option                   | note                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `width`                  | held on the active tab through every frame of a window resize, with one `AdjustPaneSize` per frame read from and verified against the tab's split tree (one in flight at a time on a mux domain, released by the sidebar's own size report); a new sidebar is split at this width, and background tabs are corrected as they activate. A divider drag is adopted the moment it moves (on a mux domain, once it has sat still for one round trip), followed wherever the hand goes, and survives config reloads until `width` itself changes                   |
