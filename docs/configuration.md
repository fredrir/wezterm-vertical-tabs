...
| option                   | note                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `width`                  | held on the active tab through every frame of a window resize, with one `AdjustPaneSize` per frame read from and verified against the tab's split tree; background tabs are corrected as they activate. A divider drag is adopted the moment it moves, followed wherever the hand goes, and survives config reloads until `width` itself changes                                                                                                                                                                                                             |
