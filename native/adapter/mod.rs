...
impl Provider for Adapter {
    ...
    fn snapshot(&mut self, snapshot: Snapshot) {
        ...
        let tabs = snapshot
            ...
            .collect::<Vec<_>>();
        // Native metadata still drives routing without Lua hooks. Retain extra copies
...
#[cfg(test)]
mod native_hook_tests {
    use super::*;
    use crate::termwindow::native_ui::TabInfo;
    ...
    #[test]
    fn native_hook_metadata_is_optional_and_survives_reconfiguration_and_retry() {
