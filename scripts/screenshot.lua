...
local VARIANTS = {
  default = { poll_ms = 200, confirm_close = false, debug = true },
  zeroconfig = {},
  elevation = { poll_ms = 200, debug = true, theme = { elevation = 0.06 } },
  ["elevation-1"] = { poll_ms = 200, debug = true, theme = { elevation = 1 } },
  press = { poll_ms = 200, debug = true, hover = "press" },
}
for k, v in pairs(VARIANTS[os.getenv "VTABS_SHOT_OPTS" or "default"] or {}) do
  opts[k] = v
end
